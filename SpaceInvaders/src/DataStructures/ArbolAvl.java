...
/**
 * Implementa m�todos de AbstractCollection y AbstractSet de forma espec�fica para 
...
public class ArbolAvl<T> extends java.util.AbstractSet<T>{
    ...
    /**
     * Constructor para recibir el comparador que se utilizar� para comparar los elementos. Si
     * no se construye el �rbol con este m�todo los objetos se compararan en funci�n del orden
     * natural (comparable).
    ...
    /**
     * Este m�todo recorre el �rbol mediante el recorrido INORDEN y almacena cada elemento.
